...
import ilhoyu.gasprice.lib.EthUnit
import ilhoyu.gasprice.lib.hexToBigDecimal
import ilhoyu.gasprice.lib.hexToLong
...
data class GasPriceSummary(
    ...
    companion object {
        ...
        fun checkIfValidBlock(ethBlock: EthBlock) = !ethBlock.number.isNullOrEmpty()

        fun checkIfInvalidBlock(ethBlock: EthBlock) = !checkIfValidBlock(ethBlock)

        fun from(ethBlock: EthBlock, sortOrder: GasPriceSortedBy): GasPriceSummary? {
            if (checkIfInvalidBlock(ethBlock)) return null
